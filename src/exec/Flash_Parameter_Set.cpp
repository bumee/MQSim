...
sim_time_type Flash_Parameter_Set::Page_Program_Latency_LSB = 1300000;
sim_time_type Flash_Parameter_Set::Page_Program_Latency_CSB = 1300000;
sim_time_type Flash_Parameter_Set::Page_Program_Latency_MSB = 1300000;
sim_time_type Flash_Parameter_Set::Block_Erase_Latency = 5000000;//Block erase latency in nano-seconds
unsigned int Flash_Parameter_Set::Block_PE_Cycles_Limit = 3000;
...
unsigned int Flash_Parameter_Set::Die_No_Per_Chip = 1;
unsigned int Flash_Parameter_Set::Plane_No_Per_Die = 1;
unsigned int Flash_Parameter_Set::Block_No_Per_Plane = 128;
unsigned int Flash_Parameter_Set::Page_No_Per_Block = 128;//Page no per block
unsigned int Flash_Parameter_Set::Page_Capacity = 8192;//Flash page capacity in bytes
unsigned int Flash_Parameter_Set::Page_Metadat_Capacity = 1872;//Flash page capacity in byte
